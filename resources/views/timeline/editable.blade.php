                ...
                @foreach($statuses as $status)
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            {{--<imgs class="media-object" alt="" src="">--}}
                            {{--</a>--}}
                            {{--<div class="media-body">--}}
                            {{--<h5 class="media-body"><a href="#">Billy</a></h5>--}}
                            {{--<p>Yes it is lovely day</p>--}}
                            {{--<ul class="list-inline">--}}
                            {{--<li>8 minutes ago.</li>--}}
                            {{--<li><a href="#">Like</a></li>--}}
                            {{--<li>12 Likes</li>--}}
                            ...
                            <form role="form" action="#" method="post">
                                <div class="form-group">
                                    <textarea name="reply-1" class="form-control" rows="2" placeholder="Reply to this status">
                                    </textarea>
                                </div>
